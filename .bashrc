...
if [ "$color_prompt" = yes ]; then
    ...
    # PS1='\n$(if [[ $? == 0 ]]; then echo "\[\e[32m\]:)"; else echo "\[\e[31m\]:("; fi) \e[31m[\t] \e[1;34m\u\e[0m in \e[1;95m\w\e[0m $(git branch 2>/dev/null | sed -n "s/* \(.*\)/\1/p")\n$ '
    PS1='\n$(if [[ $? == 0 ]]; then echo "\[\e[32m\]:)"; else echo "\[\e[31m\]:("; fi) \e[1;34m\u\e[0m in \e[1;95m\w\e[0m at \e[1;32m\h\e[0m $(git branch 2>/dev/null | sed -n "s/* \(.*\)/\1/p")\n$ '
...
# path of default flutter sdk bin dir
